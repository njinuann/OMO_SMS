...
public class HTMLWorker implements SimpleXMLDocHandler, DocListener
{
     ...
     * com.lowagie.text.Document adding the elements to a Document directly, or an HTMLWorker instance strong
    ...
    /**
     * Flushes the current paragraph, indicating that we're starting a new block. If the stack is empty, the
     * paragraph is added to the document. Otherwise the Paragraph is added to the stack.
     *
     * @since 5.0.6
     */
    ...
    /**
     * Fetches the List from the Stack and adds it to the TextElementArray on top of the Stack, or to the
