...
public class ChainedProperties
{
    ...
    /**
     * Walks through the hierarchy (bottom-up) looking for a property key. Returns a value as soon as a match
    ...
    /**
     * Walks through the hierarchy (bottom-up) looking for a property key. Returns true as soon as a match is
    ...
    /**
     * If the properties contain a font size, the size may need to be adjusted based on font sizes higher in
     * the hierarchy.
     *
