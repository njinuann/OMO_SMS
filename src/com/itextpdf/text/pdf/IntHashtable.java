 ...
 *
 * <p>
 * Note that this class is for internal optimization purposes only, and may not be supported in future
 * releases of Jakarta Commons Lang. Utilities of this sort may be included in future releases of Jakarta
...
public class IntHashtable implements Cloneable
{
     ...
     * <
     * p>
     * Tests if some key maps into the specified value in this hashtable. This operation is more expensive
     * than the <code>containsKey</code> method.</p>
     *
     * <p>
     * Note that this method is identical in functionality to containsValue, (which is part of the Map
     * interface in the collections framework).</p>
     *
     * @param value a value to search for.
     * @return     <code>true</code> if and only if some key maps to the <code>value</code> argument in this
     * hashtable as determined by the <tt>equals</tt> method; <code>false</code> otherwise.
     ...
     * @return <code>true</code> if and only if the specified int is a key in this hashtable, as determined by
     * the <tt>equals</tt>
     ...
     * @return the value to which the key is mapped in this hashtable; <code>null</code> if the key is not
     ...
     * <
     * p>
     * Increases the capacity of and internally reorganizes this hashtable, in order to accommodate and access
     * its entries more efficiently.</p>
     *
     * <p>
     * This method is called automatically when the number of keys in the hashtable exceeds this hashtable's
     * capacity and load factor.</p>
     */
     ...
     * <
     * p>
     * Maps the specified <code>key</code> to the specified <code>value</code> in this hashtable. The key
     ...
     * @return the previous value of the specified key in this hashtable, or <code>null</code> if it did not
     * have one.
     ...
     * @return the value to which the key had been mapped in this hashtable, or <code>null</code> if the key
